...
export type EMAction = IEMBleAction & IEMConnectBleAction & IEMUpdateBleConnectionAction & IEMBleDataAction & IEMBleChunkedAction & IEMBleSetValueAction & IEMErrorAction;
...
export interface IEMErrorAction {
    error: string;
}